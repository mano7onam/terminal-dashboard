...
_IDE_SPECS = [
    ...
    },
    {
        "id": "pycharm",
        "name": "PyCharm",
        "apps": ["PyCharm", "PyCharm CE", "PyCharm Professional", "IntelliJ IDEA"],
        # JetBrains Toolbox often installs versioned names
        "cli": ["pycharm", "charm"],
        "open_a": ["PyCharm", "PyCharm CE", "PyCharm Professional"],
        "open_a_globs": True,  # also scan /Applications for PyCharm*
    },
    {
        "id": "idea",
        "name": "IntelliJ IDEA",
